...
- **内容 9 篇**：论文3(架构/训练/推理) · AI商业落地1(律所) · 展会&活动4(具身/龙岗/WAIC Day1/Day2) · 读书·播客2(Harness/Agent演进)
- 改首页文案改 `src/site.config.ts`；加内容丢 `src/content/notes/*.md`；`git push` 自动上线

## 待办（按优先级）

### 🔴 立即
- [ ] Day2 文章 build + push 上线（本地已写好 + 图已按修正名更新）

### 🟡 内容补充（素材在得到大脑录音笔记）
- [ ] 读书·播客（现 2 篇）：姚顺雨 Agent 深度访谈、罗振宇长期主义、戴雨森 AI 投资等
- [ ] AI 商业落地（现 1 篇）：加新行业（医疗/制造/教育）
- [ ] 展会&活动（现 4 篇）：Day3 或其他展会素材

### 🟢 网站功能
- [ ] 栏目列表页（点"展会""论文"进完整列表，而非首页锚点）
- [ ] RSS + sitemap（订阅 + SEO）
- [ ] About 详情页
- [ ] dark mode
- [ ] 站内搜索
