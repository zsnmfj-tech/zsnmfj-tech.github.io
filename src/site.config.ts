...
export const site = {
  ...
  // 首页 Hero
  kicker: '实践笔记 · 自 2026',
  tagline: '在 AI 落地、空间智能与具身智能的交界处，记录实践、阅读与观察。把所见所想摆出来，等同行来交流。',
  dirs: ['AI', '空间智能', '具身智能'],

  // 关于
  aboutTitle: '关于我',
  about: '11 年技术与管理背景，过去 7 年深耕 AI 大数据与云服务，做过招行账户合规智能监测这类项目。现在把注意力放在三件事上：<strong>AI 怎么真正落到一个行业、空间智能（Spatial）的新机会、具身智能的产业化</strong>。这里是我日常所学所见的沉淀地，也欢迎来聊合作与机会。',
